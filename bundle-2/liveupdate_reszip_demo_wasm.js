...
var wasmImports = {
  b: ___assert_fail,
  Mh: ___syscall__newselect,
  Lh: ___syscall_accept4,
  Kh: ___syscall_bind,
  Jh: ___syscall_connect,
  Ih: ___syscall_dup3,
  f: ___syscall_fcntl64,
  Hh: ___syscall_getpeername,
  Gh: ___syscall_getsockname,
  _: ___syscall_getsockopt,
  Fh: ___syscall_ioctl,
  Eh: ___syscall_listen,
  Dh: ___syscall_mkdirat,
  Z: ___syscall_openat,
  Ch: ___syscall_poll,
  Bh: ___syscall_readlinkat,
  Ah: ___syscall_recvfrom,
  zh: ___syscall_renameat,
  yh: ___syscall_rmdir,
  xh: ___syscall_sendto,
  sa: ___syscall_socket,
  wh: ___syscall_stat64,
  Y: ___syscall_unlinkat,
  th: __emscripten_get_now_is_monotonic,
  sh: __emscripten_lookup_name,
  rh: __emscripten_system,
  qh: __emscripten_throw_longjmp,
  ya: __gmtime_js,
  xa: __localtime_js,
  wa: __mktime_js,
  ph: __tzset_js,
